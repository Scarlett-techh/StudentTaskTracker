                ...
                parent.innerHTML = `
                  <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-green-100 to-green-200">
                    <div class="text-center">
                      ...
                      <p class="text-xs text-green-800 font-medium">PHOTO</p>
                    </div>
                  </div>
                `;
              }
                  ...
                  parent.innerHTML = `
                    <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-blue-100 to-blue-200">
                      <div class="text-center">
                        ...
                        <p class="text-xs text-blue-800 font-medium">${fileExt?.toUpperCase() || 'FILE'}</p>
                      </div>
                    </div>
                  `;
                }
      ...
      return (
        <div className="w-full h-32 bg-gradient-to-br from-purple-100 to-purple-200 rounded-lg flex items-center justify-center mb-3">
          <div className="text-center">
            ...
            <p className="text-xs text-purple-800 font-medium">LINK</p>
          </div>
        </div>
      );
    }

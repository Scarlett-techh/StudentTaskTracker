...
This report shows progress across all learning activities.`;
  ...
  const handleShareReport = () => {
    const reportData = `My Learning Progress: ${completedTasks.length} tasks completed, Level ${stats?.level || 1}, ${stats?.points || 0} points earned!`;
                  ...
                  {stats && stats.streak > 0 && (
                    <div className="bg-purple-50 p-4 rounded-lg border border-purple-100">
                      ...
                      <p className="text-purple-800">
                        Your {stats.streak}-day streak shows excellent consistency. 
